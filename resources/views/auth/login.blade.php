            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="d-flex justify-content-center my-3">
                        <div class="btn-group">
                            <a class='btn btn-info disabled'><i class="fa fa-twitter text-white" style="width:16px; height:20px"></i></a>
                            <a class='btn btn-info' href='/login/twitter' style="width:12em"> Sign in with Twitter</a>
                        </div>
                    </div>
